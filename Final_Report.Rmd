...
We applied treatment at various time periods since our data was collected over several weeks. We did not always have completed data on the previous group prior to treating the current group due to our 72 hour waiting period. This did not concern us as we saw little possibility of interaction between subjects. We demonstrate these characteristics using ROXO grammar in the following diagram. 
...
stargazer(model.4, model.3, model.2, model.1,
          se=c(robust.se.4, robust.se.3, robust.se.2, robust.se.1),

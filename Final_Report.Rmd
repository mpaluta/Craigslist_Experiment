...
The Residuals vs Fitted plot shows a slight trend. This isn't extremely surprising given that we are fitting a binary outcome and know that there is some nonlinearity present. We will be cautious with our inference from regression and will make sure it agrees with our other analysis methods. The homoskadasticity assumption appears to hold although it is a little hard to determine again due to the nonlinearity. We used heteroskedasticity-robust standard errors for our inference in an abundance of caution.

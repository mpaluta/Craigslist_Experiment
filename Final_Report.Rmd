...
table(ate_vec<ate)
```
This shows that, out of 1000 random instantiations, 4013 show an effect stronger than our calculated ATE, implying a p-value of 0.4013, a non-statistically significant result
